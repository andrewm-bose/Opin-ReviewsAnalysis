...
## Methodology
An initial dataset of ![3.2M Amazon Electronics category customer reviews](https://s3.amazonaws.com/amazon-reviews-pds/readme.html) is tokenized using nltk and gensim: 
