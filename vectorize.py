...
w2v = Word2Vec(processed_corpus, # input tokenized text
                 min_count=5,   # Ignore words that appear less than this, 2-5 seems good
                 size=300,      # Dimensionality of word embeddings, usually 50-300
                 workers=99,     # Number of processors (parallelisation) to use
                 window=6,     # Context window for words during training, recommended 6-15
